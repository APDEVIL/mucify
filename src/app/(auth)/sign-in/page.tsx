    ...
    <div className="flex min-h-screen items-center justify-center bg-black px-4">
      <div className="w-full max-w-sm">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              <Input
                ...
                placeholder="••••••••"
                required
                className="border-zinc-700 bg-zinc-800 text-white placeholder:text-zinc-500 focus-visible:ring-zinc-500 pr-10"
              />
              <button
                type="button"
        ...
        <p className="mt-6 text-center text-sm text-zinc-400">
          ...
          <Link href="/sign-up" className="text-white underline hover:text-green-400">
            Sign up
          </Link>
        </p>
